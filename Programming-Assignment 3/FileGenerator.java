...
public class FileGenerator
{
	public static void main(String[] args) throws IOException {
		...
		for(i=0;i<411;i++) {
            ...
            String fileName = newStringLine(1);
			try {
				...
				else if(file_10kb<100) {
					CopyStringToFile(bw, 100);
					file_10kb++;
				}
				else if(file_100kb<100) {
					CopyStringToFile(bw, 1024);
					file_100kb++;
				}
				else if(file_1mb<100) {
					CopyStringToFile(bw, 10240);
					file_1mb++;
				}
				else if(file_10mb<10) {
